...
def repack(num):
    ...
    while num > 0:
        if num >= 1000:
            ...
            new += "CM"
            num -= 900
        elif num >= 500 and new.count("D") == 0:
            new += "D"
            num -= 500
        elif num >= 400 and new.count("D") == 0:
            new += "CD"
            num -= 400
        elif num >= 100:
            new += "C"
            ...
            new += "XC"
            num -= 90
        elif num >= 50 and new.count("L") == 0:
            new += "L"
            num -= 50
        elif num >= 40 and new.count("L") == 0:
            new += "XL"
            num -= 40
        elif num >= 10:
            new = new + "X"
            ...
            new += "IX"
            num -= 9
        elif num >= 5 and new.count("V") == 0:
            new += "V"
            num -= 5
        elif num == 4 and new.count("V") == 0:
            new += "IV"
            num -= 4
        elif num >= 1:
            new += "I"
